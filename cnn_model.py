...
class CNNModel(object):
    ...
    def input_layer(self, X_images, name):
        ...
        self.network = input_data(shape=[
            None, X_images.shape[1], X_images.shape[2], X_images.shape[3]
        ],
    ...
    def define_network(self, X_images, mode='testtrain'):
        ...
        conv_layer_1 = self.convolution_layer(32, 5, 'conv1', 'relu',
                                              'L2')  # 50 filters, with size 3
        mp_layer_1 = self.max_pooling_layer(
            2, 'mp1')  # downsamples spatial size by 2
        ...
        fully_connected_layer_1 = self.fully_connected_layer(
            512, 'relu', 'fl1')
