...
class CNN(object):
    ...
    def define_network(self, X):
        ...
        self.model.add(Dense(512, activation=activations.relu, name="dense1",))
        self.model.add(Dropout(0.5, name="dp1"))
        self.model.add(Dense(2, activation=activations.softmax, name="dense2",))
    ...
    def train(self, model_dir, X, Y, X_validate, Y_validate):
        ...
        tensorboard_callback = TensorBoard(
            log_dir=logdir, write_graph=True, write_images=True, histogram_freq=0
        )
        self.model.fit(
